            ...
            <nav className="navbar-default navbar-static-side" role="navigation">
                <ul className="nav metismenu" id="side-menu" ref="menu">
                    <li className="nav-header">
                        <div className="dropdown profile-element"> <span>
                            ...
                            <span className="clear"> <span className="block m-t-xs"> <strong
                                className="font-bold">HRD</strong>
                    ...
                    <li className={this.activeRoute("/pegawai")}>
                        <Link to="/pegawai"><i className="fa fa-th-large"></i> <span
                            className="nav-label">Pegawai</span></Link>
                    </li>
                    <li className={this.activeRoute("/pengajuan")}>
                        <Link to="/pengajuan"><i className="fa fa-users"></i> <span
                            className="nav-label">Pengajuan Gaji</span></Link>
                    </li>
                </ul>
            </nav>
        )
