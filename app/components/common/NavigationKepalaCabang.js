            ...
            <nav className="navbar-default navbar-static-side" role="navigation">
                <ul className="nav metismenu" id="side-menu" ref="menu">
                    ...
                    <li className={this.activeRoute("/jurusan")}>
                        <Link to="/jurusan"><i className="fa fa-graduation-cap"></i> <span
                            className="nav-label">Jurusan</span></Link>
                    </li>
                    <li className={this.activeRoute("/admin")}>
                        <Link to="/admin"><i className="fa fa-users"></i> <span
                            className="nav-label">Administrator</span></Link>
                    </li>
                    ...
                    <li className={this.activeRoute("/keuangan")}>
                        <Link to="/keuangan"><i className="fa fa-credit-card-alt"></i> <span
                            className="nav-label">Keuangan</span></Link>
                    </li>
                    <li>
                        <a><i className="fa fa-database"></i> <span className="nav-label">View Kampus</span> <span
