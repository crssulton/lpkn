...
class Mahasiswa extends Component {
    ...
    onFilterData = () => {
        ...
        fetch(
            BASE_URL +
            `/api/mahasiswa/?status=bekerja&mahasiswa=${mahasiswa}&kelas=${kelas}&jurusan=${jurusan}`,
            {
                method: "get",
                headers: {
                    Authorization: "JWT " + window.sessionStorage.getItem("token")
                            ...
                            {this.state.mahasiswas
                                ...
                                .map((data, key) => (
                                    <tr>
                                        ...
                                        <td>
                                            {data.bekerja[0].tempat}
                                        </td>
                                        <td>
                                            {moment(data.bekerja[0].tanggal_mulai).format("DD-MM-YYYY")}
                                        </td>
                                    </tr>
                                ))}
