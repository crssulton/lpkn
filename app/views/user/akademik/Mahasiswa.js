...
class Mahasiswa extends Component {
    ...
    exportData(){
        printJS({
            ...
            maxWidth:'1300',
            font_size:'8pt',
            documentTitle:'DAFTAR MAHASISWA AKTIF',
            targetStyles: ['*']
        })
    }
    ...
    componentDidMount() {
        ...
        fetch(BASE_URL + "/api/mahasiswa/?status=aktif", {
            method: "get",
            headers: {
    ...
    onFilterData = () => {
        ...
        fetch(
            BASE_URL +
            `/api/mahasiswa/?status=aktif&mahasiswa=${mahasiswa}&kelas=${kelas}&jurusan=${jurusan}`,
            {
                method: "get",
                headers: {
                    Authorization: "JWT " + window.sessionStorage.getItem("token")
