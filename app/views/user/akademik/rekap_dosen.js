				                        ...
				                        >
				                          ...
				                          {this.state.absensi
				                              ...
				                              <option key={key} value={key}>
				                                {absensi.mata_kuliah_info.nama} | {absensi.kelas_info.nama} | Angkatan {absensi.kelas_info.angkatan}
				                              </option>
				                            ))}
				                        </select>
                                      </div>
                                		...
                                		<div className="col-lg-12">
	                                        ...
	                                        <table className="">
                                				...
                                				<tr style={{'width': '100%'}}>
                                					...
                                					<td> <h4> : {this.state.selectedKelas != "" ? this.state.kelas.find(x => x.id == this.state.selectedKelas).nama : null}</h4></td>
                                				</tr>
                                				<tr style={{'width': '100%'}}>
                                					<td style={{'width': '6%'}}><h4>Angkatan</h4></td>
                                					<td> <h4> : {this.state.selectedKelas != "" ? this.state.kelas.find(x => x.id == this.state.selectedKelas).angkatan : null}</h4></td>
                                				</tr>
                                			</table>
	                                        {
	                                        	this.state.loading ?
