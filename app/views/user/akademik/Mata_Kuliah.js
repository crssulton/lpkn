	...
	editMataKuliah = () => {
		...
		fetch(BASE_URL + '/api/mata-kuliah/' + this.state.selected + '/', {
			...
			if (data.id == self.state.editMatkul.id) {
				toastr.success("Mata kuliah berhasil", "Sukses ! ")
				self.setState({
	...
	addMataKuliah = () => {
		...
		fetch(BASE_URL + '/api/mata-kuliah/', {
			...
			if (data.id != null || data.id != undefined) {
				...
				matkulBaru.kode = "";
				matkulBaru.nama = "";
				matkulBaru.jumlah_jam = "";
				matkulBaru.jumlah_pertemuan = "";
																	...
																	<td>
																		<center>
																			<button
																				...
																				type="button"
																				onClick={() => {
																					this.setState({selected: matkul.id, addForm: false})
																				}}
																			>
									...
									this.state.addForm ?
										<div className="ibox-content">
											...
											<div className="form-group row"><label className="col-lg-3 col-form-label">Kategori</label>
												<div className="col-lg-9">
													<select className="form-control m-b" name="account" value={this.state.matkulBaru.kategori}
																	onChange={this.addMatkulKategori}>
														<option>Pilih</option>
											...
											<div className="form-group row"><label className="col-lg-3 col-form-label">Jumlah
												Pertemuan</label>
												<div className="col-lg-9">
													<input
														type="number"
											...
											<div className="form-group row"><label className="col-lg-3 col-form-label">Kategori</label>
												<div className="col-lg-9">
													<select className="form-control m-b" name="account"
																	value={this.state.matkuls.filter(data => data.id === this.state.selected)[0].kategori}
