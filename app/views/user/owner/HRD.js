		        ...
		        <div className="wrapper wrapper-content">
                    <div className="row animated fadeInRight">
                        <div className="col-lg-8">
                            <div className="ibox ">
                                <div className="ibox-title" style={{'backgroundColor':'#1ab394', 'color':'white'}}>
                                    <h5> <i className="fa fa-list "></i> Daftar HRD</h5>
                                </div>
                                <div className="ibox-content">
                                	<div className="row">
	                                    ...
	                                    <div className="col-lg-5">
	                                    	<div className="col-sm-12">
	                                    		<Link to={{ pathname: 'add-staff', state: { title: 'HRD'} }}>
				                                    <button className="btn btn-info">
				                                    	<i className="fa fa-plus"></i> Tambah HRD
					                            ...
					                            <tbody>
					                            {
					                            	this.state.staffs.filter(data => data.role == 7).map((data, key) =>
					                            		<tr key={key}>
							                                ...
							                                <td style={{'width': '30%'}}>
						                                		<center>
						                                			<Link to={{ pathname: 'edit-staff', state: { staf: data, title : "HRD"} }}>
							                                			<button 
							                                				style={{'margin' : '0 5px'}} 
                        ...
                        <div className="col-lg-4">
                            <div className="ibox ">
                                <div className="ibox-title" style={{'backgroundColor':'#1ab394', 'color':'white'}}>
                                    <h5> <i className="fa fa-user"></i> Profil HRD</h5>
                                </div>
