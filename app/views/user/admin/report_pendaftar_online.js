...
class List_pendaftar extends Component {
  ...
  getPendaftar = () =>{
    ...
    fetch(BASE_URL + `/api/pendaftaran/?online=1&bulan=${selectedMonth}&kampus=${selectedKampus}&jurusan=${selectedJurusan}&limit=${selectedLimit}&tahun=${selectedYear}`, {
      method: "get",
      headers: {
        Authorization: "JWT " + window.sessionStorage.getItem("token")
      }
      ...
      <div>
        <div className="row wrapper border-bottom white-bg page-heading">
          <div className="col-lg-8">
            <h2>Export Data Pendaftar Online</h2>
            <ol className="breadcrumb">
              <li className="breadcrumb-item">Export Data</li>
              <li className="breadcrumb-item active">
                <strong>Pendaftar Online</strong>
              </li>
            </ol>
          </div>
                ...
                <div className="ibox-content">
                  ...
                  {this.state.loading ? (
                    ...
                    <div className="table-responsive" id="print_data">
                      <h3 style={{textAlign: 'center'}}>List Pendaftar Online LPKN</h3>
                      <br/>
                      ...
                      <table className="table">
                        ...
                        {this.state.pendaftars
                          .filter(item => item.online_register == true)
                          .map((pendaftar, key) => (
                            <tr key={key}>
                              <td>{key + 1}</td>
