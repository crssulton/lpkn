          ...
          <div className="row animated fadeInRight">
            <div className="ibox ">
              ...
              <div className="ibox-content">
                ...
                <div className="form-group row"><label className="col-lg-2 col-form-label">Akun Tujuan</label>
                    <div className="col-lg-4">
                    <Select
                        name="form-field-name"
                ...
                <div className="form-group row"><label className="col-lg-2 col-form-label">Jumlah Penyusutan</label>
                    <div className="col-lg-4">
                        <input 
                          type="number" 
