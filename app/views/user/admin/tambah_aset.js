...
class Tagihan extends Component {
  ...
  addtransaksi = () => {
    ...
    transaksiBaru.transaksi_aset = true;
    transaksiBaru.nama = transaksiBaru.uraian;
    transaksiBaru.harga = transaksiBaru.nominal;
          ...
          <div className="row animated fadeInRight">
            <div className="ibox ">
              ...
              >
                <h5>
                  {" "}
                  <i className="fa fa-list "/> Tambah Aset
                </h5>
              </div>
              <div className="ibox-content">
                <div className="form-group row"><label className="col-lg-2 col-form-label">Akun Penyusutan</label>
                  <div className="col-lg-4">
                    <Select
                      name="form-field-name"
                      disabled={this.state.transaksiBaru.kelompok_account}
                  ...
                  <div className="col-lg-5">
                    {/*<small className="mb-0 text-success"><code>Akun Sumber adalah akun yg disesuikan dengan kategori*/}
                    {/*  aset, jika aset ini <br/></code>*/}
                    {/*  <code>pemberian maka diseimbangkan memasukkan di modal tambahan / akun lain yg sebagai*/}
                    {/*    kredit</code></small>*/}
                  </div>
                </div>

                <div className="form-group row"><label className="col-lg-2 col-form-label">Akun Beban</label>
                  <div className="col-lg-4">
                    <Select
                      name="form-field-name"
                  ...
                  <div className="col-lg-5">
                    {/*<small className="mb-0 text-success"><code>Akun Tujuan adalah akun tempat mengambil uang untuk*/}
                    {/*  mendapatkan aset</code></small>*/}
                  </div>
                </div>

                <div className="form-group row"><label className="col-lg-2 col-form-label">Jumlah Penyusutan /
                  Tahun</label>
                  <div className="col-lg-4">
                    <input
                      type="number"
                      ...
                      name="transaksi"
                      value={this.state.transaksiBaru.jumlah_penyusutan}
                      onChange={this.addtransaksiPenyusutan}
                    />
                  </div>
                  <div className="col-lg-5">
                    <small className="mb-0 text-success"><code>Nilai angka jumlah penyusutan aset per tahun</code>
                    </small>
                  </div>
                </div>

                <div className="form-group row"><label className="col-lg-2 col-form-label">Uraian</label>
                  <div className="col-lg-4">
                    <input
                      type="text"
                      className="form-control m-b"
                ...
                <div className="form-group row"><label className="col-lg-2 col-form-label">Tanggal Pembelian</label>
                  <div className="col-lg-4">
                    <input
                      type="date"
                      className="form-control m-b"
