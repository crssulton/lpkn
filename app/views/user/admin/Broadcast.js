                ...
                if (willDelete) {
                    fetch(BASE_URL + '/api/pengumuman/' + id, {
                        ...
                        if (response.status == 204) {
                            self.setState({
                                pengumuman: self.state.pengumuman.filter(data => data.id != id)
                            })
                            toastr.success("Pengumuman berhasil dihapus", "Sukses ! ")
                        } else {
                            toastr.warning("Pengumuman gagal dihapus", "Gagal ! ")
                        }
                    }).then(function (data) {
                        ...
                        <div role="tabpanel" id="tab-2" className="tab-pane">
                            <div className="panel-body">
                                <table className="table">
                                    ...
                                    <tbody>
                                    {
                                        this.state.pengumuman.filter(asal => asal.dari == 3).map((pengumuman, key) =>
                                            ...
                                            <tr key={key}>
                                                ...
                                                <td>
                                                    <center>
                                                        <button
                                                            onClick={() => this.handleDeletePengumuman(pengumuman.id)}
