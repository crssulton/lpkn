...
class List_pendaftar extends Component {
  ...
  getPendaftar = () =>{
    ...
    fetch(BASE_URL + `/api/pendaftaran/?online=0&bulan=${selectedMonth}&kampus=${selectedKampus}&jurusan=${selectedJurusan}&limit=${selectedLimit}&tahun=${selectedYear}`, {
      method: "get",
      headers: {
        Authorization: "JWT " + window.sessionStorage.getItem("token")
      }
      ...
      <div>
        <div className="row wrapper border-bottom white-bg page-heading">
          <div className="col-lg-8">
            <h2>Export Data Pendaftar Manual</h2>
            <ol className="breadcrumb">
              <li className="breadcrumb-item">Export Data</li>
              <li className="breadcrumb-item active">
                <strong>Pendaftar Manual</strong>
              </li>
            </ol>
          </div>
            ...
            <div className="col-lg-12">
              <div className="ibox ">
                ...
                >
                  <h5>
                    {" "}
                    <i className="fa fa-list " /> Daftar Pendaftar Manual
                  </h5>
                </div>
                <div className="ibox-content">
                  ...
                  {this.state.loading ? (
                    ...
                    <div className="table-responsive" id="print_data">
                      <h3 style={{textAlign: 'center'}}>List Pendaftar Manual LPKN</h3>
                      <br/>
                      ...
                      <table className="table">
                        ...
                        <tbody>
                          ...
                          {this.state.pendaftars
                            .filter(item => item.online_register == false)
                            .map((pendaftar, key) => (
                              <tr key={key}>
                                <td>{key + 1}</td>
