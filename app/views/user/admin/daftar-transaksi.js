...
class Jadwal extends Component {
    ...
    fetchTransaksi = () => {
        const self = this
        fetch(BASE_URL + "/api/transaksi/?kampus=" + window.sessionStorage.getItem('kampus_id'), {
            method: "get",
            headers: {
                Authorization: "JWT " + window.sessionStorage.getItem("token")
            }
                                ...
                                <div className="ibox-content">
                                    <div className="row">
                                        <div className="col-lg-3">
                                            <label className="form-label">Akun Transaksi : </label>
                                        </div>
                                        ...
                                        <div>
                                            <table className="table table-bordered">
                                                ...
                                                {this.state.transaksi != null
                                                    ? this.state.transaksi.filter(x => x.kampus_info.id == kampus).map((transaksi, key) => (
                                                        <tr key={key}>
                        ...
                        <div className="modal-content animated bounceInRight">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="form-group row">
                                    ...
                                    <div className="col-lg-10">
                                        <p>: Rp. {this.state.transaksi_selected != null? this.formatNumber(this.state.transaksi_selected.nominal_sebelum) : null}</p>
                                    </div>
                                </div>
                                <div className="form-group row">
