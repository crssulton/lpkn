            ...
            <div className="col-lg-12">
              <div className="ibox ">
                ...
                >
                  <h5>
                    {" "}
                    <i className="fa fa-list " /> Jadwal Perkuliahan
                  </h5>
                </div>
                          ...
                          {this.state.jadwals
                            .filter(
                              data =>
                                ...
                                this.state.mahasiswa.jurusan_info.id &&
                                data.kelas_info.id == this.state.mahasiswa.kelas
                            )
                            .map((jadwal, key) => (
                              <tr
                                key={key}
                  ...
                  .map((jadwal, key) => (
                    <tr key={key}>
                      <th>
                        {
                          this.state.days.find(
                            dy => dy.day == moment(jadwal.start).format("dddd")
                          ).hari
                        }
                      </th>
